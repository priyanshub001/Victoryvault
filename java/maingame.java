...
//
    ...
    private void showBottomDialog() {
        ...
        freefire.setOnClickListener(v -> {
            dialog.dismiss();
            Toast.makeText(maingame.this, "Free fire selected", Toast.LENGTH_SHORT).show();
        });

        bgmi.setOnClickListener(v -> {
            dialog.dismiss();
            Toast.makeText(maingame.this, "BGMI selected", Toast.LENGTH_SHORT).show();
        });

        ludo.setOnClickListener(v -> {
            dialog.dismiss();
            Toast.makeText(maingame.this, "Ludo selected", Toast.LENGTH_SHORT).show();
        });
