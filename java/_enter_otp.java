    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyOtpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otp.isEmpty()) {
                    Toast.makeText(_enter_otp.this, "Please enter the OTP", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(_enter_otp.this, "OTP verified successfully!", Toast.LENGTH_SHORT).show();
                        // Redirect to the next activity, like reset password
                        Intent intent = new Intent(_enter_otp.this, _new_password.class);
                        startActivity(intent);
                        finish();
                    } else {
                        // OTP verification failed
                        Toast.makeText(_enter_otp.this, "Invalid OTP, please try again.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
