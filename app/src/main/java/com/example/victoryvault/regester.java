        ...
        regester.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nametxt.isEmpty() || emailtxt.isEmpty() || usernametxt.isEmpty() || passwordtxt.isEmpty() || mobiletxt.isEmpty()){
                    Toast.makeText(regester.this, "Please enter the all field", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.hasChild(usernametxt)){
                                ...
                                Toast.makeText(regester.this, "Username is already taken", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(regester.this, "Regester successfully", Toast.LENGTH_SHORT).show();
