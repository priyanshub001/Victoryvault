    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(v -> {
            if (isNameChanged() || isEmailChanged() || isMobileChanged()) {
                saveUserData();
                Toast.makeText(com.victoryvault.java.edit_profile.this, "Profile updated successfully!", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(getApplicationContext(), maingame.class); // Replace HomeActivity with your actual activity class
                startActivity(intent);

            } else {
                Toast.makeText(com.victoryvault.java.edit_profile.this, "No changes detected.", Toast.LENGTH_SHORT).show();
            }
        });

        // Set up swipe refresh
        swipeRefreshLayout.setOnRefreshListener(() -> {
            ProgressDialog progressDialog = new ProgressDialog(com.victoryvault.java.edit_profile.this);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                if (isBackPressed) {
                    ...
                    Toast.makeText(com.victoryvault.java.edit_profile.this, "Press back again to exit.", Toast.LENGTH_SHORT).show();
                    isBackPressed = true;
